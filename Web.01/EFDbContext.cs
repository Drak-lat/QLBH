    ...
    internal class EFDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            new Customer
            {
                ...
                Name = "Lý Qua Cầu",
                Gender = false,
                BirthDate = DateTime.Parse("1990-01-25"),
             ...
             new Customer
             {
                 ...
                 Name = "Trần Văn Sơn",
                 Gender = true,
                 BirthDate = DateTime.Parse("2000-11-20"),
             ...
             new Customer
             {
                 ...
                 Gender = null,
                 BirthDate = DateTime.Parse("1980-05-15"),
             ...
             new Customer
             {
                 ...
                 Name = "Cao Thu Trang",
                 Gender = false,
                 BirthDate = DateTime.Parse("1991-07-09"),
                 Address =
                "666/3 Nguyễn Trãi, P1, Tân An, Long An",
                 Phone = "0623456789",
                 Status = true,
             ...
             new Customer
             {
                 ...
                 Name = "Nguyễn Kiểu",
                 Gender = false,
                 BirthDate = DateTime.Parse("1982-03-04"),
                 Address =
                 "466/3 Nguyễn Du, P6, Gò Dầu, Tây Ninh",
                 Phone = "0823456789",
                 Status = true,
             ...
             new Customer
             {
                 ...
                 BirthDate = DateTime.Parse("1990-01-25"),
                 Address =
                 "11A Lý Bí, P5, Q1, TP. Hồ Chí Minh",
                 Phone = "0133456789",
                 Status = true,
             ...
             new Customer
             {
                 ...
                 BirthDate = DateTime.Parse("2000-11-20"),
                 Address =
                "1110 Lê Thái Tổ, P1, Q2, TP. Hồ Chí Minh",
                 Phone = "0973456789",
                 Status = true,
             ...
             new Customer
             {
                 ...
                 BirthDate = DateTime.Parse("1980-05-15"),
                 Address
                = "91/2A Trần Quốc Toản, P4, Q5, TP. Hồ Chí Minh",
                 Phone = "0823456789",
                 Status = true,
             ...
             }, new Customer
             {
                 ...
                 BirthDate = DateTime.Parse("1991-07-09"),
                 Address =
                "34212 Nguyễn Trãi, P1, Tân An, Long An",
                 Phone = "0623456789",
                 Status = true,
             ...
             new Customer
             {
                 ...
                 BirthDate = DateTime.Parse("1982-03-04"),
                 Address =
                 "567/81 Nguyễn Đình Chiểu, P6, Gò Dầu, Tây Ninh",
                 Phone = "0923456789",
                 Status = true,
            ...
            new Employee
            {
                ...
                Name = "Lý Bình Minh",
                Gender = false,
                BirthDate = DateTime.Parse("1992-01-25"),
                Address =
                "11A Lý Thường Kiệt, P5, Q2, TP. Hồ Chí Minh",
                Phone = "0133451111",
                Status = true,
          ...
          new Employee
          {
              ...
              Name = "Trần Văn Hải",
              Gender = true,
              BirthDate = DateTime.Parse("2001-11-20"),
        ...
        new Employee
        {
            EmployeeID = 3,
            Name = "Hoàng Đế",
            Gender = null, // Đảm bảo Gender có kiểu nullable bool? trong lớp Employee
            BirthDate = DateTime.Parse("1976-05-15"),
